...
export type TransitionName = 'CAPE_WIPE' | 'VELOCITY_CUT' | 'WHIP';
...
export interface SourceClip {
  ...
  heroRanges: HeroRange[]; tags: string[]; faceStability?: number; edgeStability?: number; motionQuality?: number;
}
...
export interface FrameContext {
  ...
  transform: EditTransform; velocity: CameraVelocity; transition: TransitionState; postFX: PostFXState;
}
